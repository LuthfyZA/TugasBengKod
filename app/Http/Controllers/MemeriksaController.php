...
class MemeriksaController extends Controller
{
    ...
    public function memeriksa($id)
    {
        ...
        return view('dokter.memeriksa.memeriksa', compact('periksa', 'obats', 'detail_periksa', 'selected_obats'));
    }
    ...
    public function edit($id)
    {
        ...
        // Mengirimkan data ke view
        return view('dokter.memeriksa.edit', compact('periksa', 'obats', 'detail_periksa', 'selected_obats'));
    }
    ...
    public function store(Request $req)
    {
        ...
        $req->validate([
            ...
            'obat' => 'nullable|array',
            'obat.*' => 'exists:obats,id'  // Mengubah ke 'obats' untuk validasi
        ]);
