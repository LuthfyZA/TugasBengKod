...
class PeriksaController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
   // Di PeriksaController.php, method store()
// Di PeriksaController.php, method store()
public function store(Request $req)
{
    ...
    // Tambahkan nilai default untuk tgl_periksa dan biaya_periksa
    $data = $req->all();
    if (!isset($data['tgl_periksa'])) {
        $data['tgl_periksa'] = now();
    }
    if (!isset($data['biaya_periksa'])) {
        $data['biaya_periksa'] = 0; // Nilai default 0
    }
